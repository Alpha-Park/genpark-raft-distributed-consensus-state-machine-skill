...
[![GitHub stars](https://img.shields.io/github/stars/Alpha-Park/genpark-raft-distributed-consensus-state-machine-skill?style=social)](https://github.com/Alpha-Park/genpark-raft-distributed-consensus-state-machine-skill/stargazers)
...
```bash
git clone https://github.com/Alpha-Park/genpark-raft-distributed-consensus-state-machine-skill.git
